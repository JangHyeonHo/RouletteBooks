...
<header>
	...
	<div id="headerTop">
		<ul id="headerMyForm">
			...
			<c:if test="${!empty loginInfo}">
				<li class="greetLogin" style=""><span id="nick"> ${loginInfo.mNickname } </span> 님
					방문을 환영합니다.</li>
				<li class="formBtn"><a href="/roulettebooks/member/logout">로그아웃</a></li>
				<li class="formBtn">
					<div id="myPageBtn">
	...
	<div id="headerMid">
		<div id="logoIcon">
			<a href="/roulettebooks/main"><img src="../img/logo.png"
				height="100%"></a>
		</div>
		<div id="searchBox">
			<form id="searchForm">
	...
	<div id="headerBottom">
		<ul id="headerNav">
			<li><a href="/roulettebooks/rental">도서 대여<span
					style="font-size: 12px;">(Ebook)</span></a></li>
